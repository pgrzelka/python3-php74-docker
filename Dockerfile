...
RUN DEBIAN_FRONTEND=noninteractive apt-get update && apt-get -y --no-install-recommends install \
    net-tools openssh-client nano vim-tiny iputils-ping make git curl \
    php7.4 php7.4-ldap php7.4-pgsql php7.4-xmlrpc php7.4-curl php7.4-intl php7.4-dev php-pear composer \
